...
//--------------------------------------------------------------------------
G4VParameterisationPolyhedra::G4VParameterisationPolyhedra(EAxis axis, G4int nDiv, G4double width,
  ...
  : G4VDivisionParameterisation(axis, nDiv, width, offset, divType, msolid)
{
  ...
  if ((msolid->GetEntityType() != "G4ReflectedSolid") && (msol->IsGeneric()))
  {
    ...
    G4Exception("G4VParameterisationPolyhedra::G4VParameterisationPolyhedra()", "GeomDiv0001",
  ...
  if (msolid->GetEntityType() == "G4ReflectedSolid")
  {
    ...
    auto newSolid =
      new G4Polyhedra(msol->GetName(), msol->GetStartPhi(), msol->GetEndPhi() - msol->GetStartPhi(),
                      nofSides, nofZplanes, zValuesRefl, rminValues2, rmaxValues2);
...
G4double G4VParameterisationPolyhedra::ConvertRadiusFactor(const G4Polyhedra& phedra) const
{
  ...
  if ((phiTotal <= 0)
      || (phiTotal > 2 * pi + G4GeometryTolerance::GetInstance()->GetAngularTolerance()))
  {
    phiTotal = 2 * pi;
  }
...
//--------------------------------------------------------------------------
G4ParameterisationPolyhedraRho::G4ParameterisationPolyhedraRho(EAxis axis, G4int nDiv,
  ...
  : G4VParameterisationPolyhedra(axis, nDiv, width, offset, msolid, divType)
{
  ...
  if (divType == DivWIDTH)
  {
    fnDiv = CalculateNDiv(original_pars->Rmax[0] - original_pars->Rmin[0], width, offset);
  }
  else if (divType == DivNDIV)
  {
    fwidth = CalculateWidth(original_pars->Rmax[0] - original_pars->Rmin[0], nDiv, offset);
  }

#ifdef G4DIVDEBUG
  if (verbose >= 1)
  {
    G4cout << " G4ParameterisationPolyhedraRho - # divisions " << fnDiv << " = " << nDiv << G4endl
...
void G4ParameterisationPolyhedraRho::CheckParametersValidity()
{
  ...
  if (fDivisionType == DivNDIVandWIDTH || fDivisionType == DivWIDTH)
  {
    ...
    message << "In solid " << msol->GetName() << G4endl
            ...
            << "different for each solid section." << G4endl << "WIDTH will not be used !";
    G4Exception("G4ParameterisationPolyhedraRho::CheckParametersValidity()", "GeomDiv1001",
                JustWarning, message);
  }
  if (foffset != 0.)
  {
    ...
    message << "In solid " << msol->GetName() << G4endl
            << "Division along  R will be done with a width "
            << "different for each solid section." << G4endl << "OFFSET will not be used !";
    G4Exception("G4ParameterisationPolyhedraRho::CheckParametersValidity()", "GeomDiv1001",
                JustWarning, message);
  }
}
...
//--------------------------------------------------------------------------
void G4ParameterisationPolyhedraRho::ComputeTransformation(const G4int,
                                                           G4VPhysicalVolume* physVol) const
{
  ...
  if (verbose >= 2)
  {
    G4cout << " G4ParameterisationPolyhedraRho " << G4endl << " foffset: " << foffset / CLHEP::deg
  ...
  if (verbose >= 2)
  {
    G4cout << std::setprecision(8) << " G4ParameterisationPolyhedraRho " << G4endl
...
//--------------------------------------------------------------------------
void G4ParameterisationPolyhedraRho::ComputeDimensions(G4Polyhedra& phedra, const G4int copyNo,
                                                       const G4VPhysicalVolume*) const
{
  ...
  {
    width = CalculateWidth(origparamMother->Rmax[ii] - origparamMother->Rmin[ii], fnDiv, foffset);
...
//--------------------------------------------------------------------------
G4ParameterisationPolyhedraPhi::G4ParameterisationPolyhedraPhi(EAxis axis, G4int nDiv,
                                                               G4double width, G4double offset,
                                                               G4VSolid* msolid,
                                                               DivisionType divType)
  : G4VParameterisationPolyhedra(axis, nDiv, width, offset, msolid, divType)
{
  ...
  if (verbose >= 1)
  {
    G4cout << " G4ParameterisationPolyhedraPhi - # divisions " << fnDiv << " = " << nDiv << G4endl
           << " Offset " << foffset << " = " << offset << G4endl << " Width " << fwidth << " = "
           << width << G4endl;
  }
#endif
...
void G4ParameterisationPolyhedraPhi::CheckParametersValidity()
{
  ...
  if (fDivisionType == DivNDIVandWIDTH || fDivisionType == DivWIDTH)
  {
    ...
    message << "In solid " << msol->GetName() << G4endl
            ...
            << "in the defined numSide." << G4endl << "WIDTH will not be used !";
    G4Exception("G4ParameterisationPolyhedraPhi::CheckParametersValidity()", "GeomDiv1001",
                JustWarning, message);
  }
  if (foffset != 0.)
  {
    ...
    message << "In solid " << msol->GetName() << G4endl
            << "Division along PHI will be done splitting "
            << "in the defined numSide." << G4endl << "OFFSET will not be used !";
    G4Exception("G4ParameterisationPolyhedraPhi::CheckParametersValidity()", "GeomDiv1001",
                JustWarning, message);
  }
  ...
  if (origparamMother->numSide != fnDiv && fDivisionType != DivWIDTH)
  {
    ...
    message << "Configuration not supported." << G4endl
            << "Division along PHI will be done splitting in the defined" << G4endl
            << "numSide, i.e, the number of division would be :" << origparamMother->numSide
            << " instead of " << fnDiv << " !";
    G4Exception("G4ParameterisationPolyhedraPhi::CheckParametersValidity()", "GeomDiv0001",
                FatalException, message);
  }
}
                                                           ...
                                                           G4VPhysicalVolume* physVol) const
{
  ...
  if (verbose >= 2)
  {
    G4cout << " G4ParameterisationPolyhedraPhi - position: " << posi / CLHEP::deg << G4endl
           << " copyNo: " << copyNo << " - fwidth: " << fwidth / CLHEP::deg << G4endl;
  }
#endif
  ...
  if (verbose >= 2)
  {
    G4cout << std::setprecision(8) << " G4ParameterisationPolyhedraPhi " << copyNo << G4endl
           << " Position: " << origin << " - Width: " << fwidth << " - Axis: " << faxis << G4endl;
  }
#endif
}
...
//--------------------------------------------------------------------------
void G4ParameterisationPolyhedraPhi::ComputeDimensions(G4Polyhedra& phedra, const G4int,
                                                       const G4VPhysicalVolume*) const
{
  auto msol = (G4Polyhedra*)(fmotherSolid);
...
//--------------------------------------------------------------------------
G4ParameterisationPolyhedraZ::G4ParameterisationPolyhedraZ(EAxis axis, G4int nDiv, G4double width,
                                                           G4double offset, G4VSolid* msolid,
                                                           DivisionType divType)
  : G4VParameterisationPolyhedra(axis, nDiv, width, offset, msolid, divType),
    fOrigParamMother(((G4Polyhedra*)fmotherSolid)->GetOriginalParameters())
{
  ...
  if (divType == DivWIDTH)
  {
    fnDiv = CalculateNDiv(fOrigParamMother->Z_values[fOrigParamMother->Num_z_planes - 1]
                            - fOrigParamMother->Z_values[0],
                          width, offset);
  }
  else if (divType == DivNDIV)
  {
    fwidth = CalculateNDiv(fOrigParamMother->Z_values[fOrigParamMother->Num_z_planes - 1]
                             - fOrigParamMother->Z_values[0],
                           nDiv, offset);
  }
  ...
  if (verbose >= 1)
  {
    G4cout << " G4ParameterisationPolyhedraZ - # divisions " << fnDiv << " = " << nDiv << G4endl
           << " Offset " << foffset << " = " << offset << G4endl << " Width " << fwidth << " = "
           << width << G4endl;
  }
#endif
...
//------------------------------------------------------------------------
G4double G4ParameterisationPolyhedraZ::GetR(G4double z, G4double z1, G4double r1, G4double z2,
                                            G4double r2) const
{
...
G4double G4ParameterisationPolyhedraZ::GetRmin(G4double z, G4int nseg) const
{
  ...
  return GetR(z, fOrigParamMother->Z_values[nseg], fOrigParamMother->Rmin[nseg],
              fOrigParamMother->Z_values[nseg + 1], fOrigParamMother->Rmin[nseg + 1]);
}
...
G4double G4ParameterisationPolyhedraZ::GetRmax(G4double z, G4int nseg) const
{
  ...
  return GetR(z, fOrigParamMother->Z_values[nseg], fOrigParamMother->Rmax[nseg],
              fOrigParamMother->Z_values[nseg + 1], fOrigParamMother->Rmax[nseg + 1]);
}
...
void G4ParameterisationPolyhedraZ::CheckParametersValidity()
{
  ...
  if (fDivisionType == DivNDIV)
  {
    if (fOrigParamMother->Num_z_planes - 1 != fnDiv)
    {
      std::ostringstream message;
      message << "Configuration not supported." << G4endl
              << "Division along Z will be done splitting in the defined" << G4endl
              << "Z planes, i.e, the number of division would be :"
              << fOrigParamMother->Num_z_planes - 1 << " instead of " << fnDiv << " !";
      G4Exception("G4ParameterisationPolyhedraZ::CheckParametersValidity()", "GeomDiv0001",
                  FatalException, message);
    }
  }
  ...
  if (fDivisionType == DivNDIVandWIDTH || fDivisionType == DivWIDTH)
  {
    ...
    if (!fReflectedSolid)
    {
      ...
      G4double zend = fOrigParamMother->Z_values[0] + foffset + fnDiv * fwidth;
    ...
    {
      std::ostringstream message;
      message << "Configuration not supported." << G4endl << "Division with user defined width."
              << G4endl << "Solid " << fmotherSolid->GetName() << G4endl
                                                         ...
                                                         G4VPhysicalVolume* physVol) const
{
  ...
  if (fDivisionType == DivNDIV)
  {
    ...
    posi = (fOrigParamMother->Z_values[copyNo] + fOrigParamMother->Z_values[copyNo + 1]) / 2;
  ...
  if (verbose >= 2)
  {
    G4cout << std::setprecision(8) << " G4ParameterisationPolyhedraZ " << copyNo << G4endl
           << " Position: (0,0,0) - Width: " << fwidth << " - Axis: " << faxis << G4endl;
  }
#endif
}

//---------------------------------------------------------------------
void G4ParameterisationPolyhedraZ::ComputeDimensions(G4Polyhedra& phedra, const G4int copyNo,
                                                     const G4VPhysicalVolume*) const
{
  ...
  if (fDivisionType == DivNDIV)
  {
    ...
    //
    G4double posi =
      (fOrigParamMother->Z_values[copyNo] + fOrigParamMother->Z_values[copyNo + 1]) / 2;
  ...
  if (fDivisionType == DivNDIVandWIDTH || fDivisionType == DivWIDTH)
  {
    if (!fReflectedSolid)
    {
      ...
      // The position of the centre of copyNo-th division
      //
      G4double posi = fOrigParamMother->Z_values[0] + foffset + (2 * copyNo + 1) * fwidth / 2.;
    ...
    //
    if (origparam.Rmin[0] < 0.0)
    {
      origparam.Rmin[0] = 0.0;
    }
    if (origparam.Rmin[nz - 1] < 0.0)
    {
      origparam.Rmin[1] = 0.0;
    }
  }
