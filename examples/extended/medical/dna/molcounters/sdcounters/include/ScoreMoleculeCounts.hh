...
// ********************************************************************
//
/// \file ScoreMoleculeCounts.hh
/// \brief Definition of the ScoreMoleculeCounts class
...
#ifndef ScoreMoleculeCounts_hh
#define ScoreMoleculeCounts_hh 1
...
class ScoreMoleculeCounts
  : public G4VPrimitiveMoleculeScorer<MoleculeCounter, MoleculeCounterIndex, G4String, G4String>
{
  public:
    ScoreMoleculeCounts(G4String, G4String, G4int = 0);
    ~ScoreMoleculeCounts() override = default;

    std::tuple<G4String, G4String> ConvertCounterIndexToKey(const MoleculeCounterIndex&) const override;
    void WriteWithAnalysisManager() const override;

  private:
    G4bool fAppendAllCopyNumbers{false};
};
