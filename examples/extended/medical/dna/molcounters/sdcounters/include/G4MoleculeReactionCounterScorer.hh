...
// ********************************************************************
//
/// \file G4MoleculeReactionCounterScorer.hh
/// \brief Definition of the G4MoleculeReactionCounterScorer class
...
#ifndef G4MOLECULEREACTIONCOUNTERSCORER_HH
#define G4MOLECULEREACTIONCOUNTERSCORER_HH 1
...
class G4MoleculeReactionCounterScorer
  : public G4VPrimitiveMoleculeScorer<G4MoleculeReactionCounter, G4MoleculeReactionCounterIndex, G4String>
{
  public:
    G4MoleculeReactionCounterScorer(G4String, G4String, G4int = 0);
    ~G4MoleculeReactionCounterScorer() override = default;

    std::tuple<G4String> ConvertCounterIndexToKey(const G4MoleculeReactionCounterIndex&) const override;
